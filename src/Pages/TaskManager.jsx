...
export default function TaskManager() {
  ...
  const [newTask, setNewTask] = useState(localStorage.getItem("newTask") || "");
  ...
  return (
    <div className="task-manager-container">
      ...
      {/* Add Task Section */}
      <input className="task-input" type="text" placeholder="Enter a new task" value={newTask} onChange={(e) => setNewTask(e.target.value)} />
